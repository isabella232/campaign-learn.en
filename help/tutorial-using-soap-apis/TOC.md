...
+ Step 4 - Create an article alert delivery{#article-alert-email}
  + [Create an article alert delivery](/help/tutorial-using-soap-apis/create-article-alert-delivery-overview.md)
  + [Part 1 - Query articles and recipient subscription values](/help/tutorial-using-soap-apis/query-articles-and-recipient-subscription-values.md)  
  + [Part 2 - Join columns and send email delivery](/help/tutorial-using-soap-apis/join-columns-and-send-automated-email-delivery.md)
