...
+ Process management and automation{#process-management}
  ...
  + Create a content digest{#content-digest}
    + [Create a content digest with a workflow](/help/process-management/create-a-content-digest/create-a-content-digest-overview.md)
    + [Query articles and recipient subscription values](/help/process-management/create-a-content-digest/query-articles-and-recipient-subscription-values.md)
    + [Join columns and send email delivery](/help/process-management/create-a-content-digest/send-automated-email-delivery.md))
